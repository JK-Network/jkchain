...
```json
{
  ...
  "deposit": "10000000000000000000ajk"
}
```
...
```json
{
  ...
  "deposit": "64000000000000000000ajk"
}
  ...
  "changes": [
    {
      "subspace": "gov",
      "key": "depositparams",
      "value": {"mindeposit":[{"denom":"ajk","amount":"64000000000000000000"}],
      "max_deposit_period":"1209600000000000"}
    }
  ],
  "deposit": "20100000000000000000ajk"
}
```
...
The `<deposit>` is written as `500000ajk`, just like the example above.
...
- the deposit denomination is in `'atevmos'` instead of `'ajk'`
