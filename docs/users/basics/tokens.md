...
The denomination used for staking, governance and gas consumption on the EVM is the JK. The JK provides the utility of: securing the Proof-of-Stake chain, token used for governance proposals, distribution of fees to validator and users, and as a mean of gas for running smart contracts on the EVM.

Evmos uses [Atto](https://en.wikipedia.org/wiki/Atto-) JK as the base denomination to maintain parity with Ethereum.

1 evmos = 10<sup>18</sup> ajk
