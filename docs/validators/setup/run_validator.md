...
Your node consensus public key (`evmosvalconspub...`) can be used to create a new validator by staking JK tokens. You can find your validator pubkey by running:
