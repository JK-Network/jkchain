...
func (suite *IBCTestingSuite) SetupTest() {
	...
	// Mint coins on the osmosis side which we'll use to unlock our ajk
	...
	// Mint coins on the cosmos side which we'll use to unlock our ajk
...
var (
	...
	ajkDenomtrace = transfertypes.DenomTrace{
		Path:      "transfer/channel-0",
		BaseDenom: "ajk",
	}
	ajkIbcdenom = ajkDenomtrace.IBCDenom()
