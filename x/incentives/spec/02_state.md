...
Say, there are several incentives that have registered an allocation for the $JK coin and the allocation meter for $JK is at 97%. Then a new incentve proposal can only include an $JK allocation at up to 3%, claiming the last remaining allocation capcaity from the $JK rewards in the inflation pool.
